...
## 2.0.152
- pac CLI 2.11.1, (see release notes on [nuget.org](https://www.nuget.org/packages/Microsoft.PowerApps.CLI/))
- Bug Fixes and enhancements

## 2.0.150
- pac CLI 2.9.3, (see release notes on [nuget.org](https://www.nuget.org/packages/Microsoft.PowerApps.CLI/))
- Bug Fixes and enhancements
...
- Fixed active environment indicator (star) in Power Pages Actions (Desktop)
- Bug Fixes and enhancements
...
## 2.0.140
- pac CLI 2.6.4, (see release notes on [nuget.org](https://www.nuget.org/packages/Microsoft.PowerApps.CLI/))
- Bug Fixes and enhancements

## 2.0.139
- pac CLI 2.5.1, (see release notes on [nuget.org](https://www.nuget.org/packages/Microsoft.PowerApps.CLI/))
- Bug Fixes and enhancements
...
## 2.0.133
- pac CLI 2.3.2, (see release notes on [nuget.org](https://www.nuget.org/packages/Microsoft.PowerApps.CLI/))
- Bug Fixes and enhancements
