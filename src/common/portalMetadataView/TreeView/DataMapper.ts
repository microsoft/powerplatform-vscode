...
import { PortalComponentServiceFactory } from "../services/PortalComponentServiceFactory";
...
function convertWebpagesToItems(metadataContext: IPreviewEngineContext, getPath: any): IItem[] {
  return PortalComponentServiceFactory.getPortalComponent("WebPage")?.create(metadataContext, getPath) || []; 
  // const items: IItem[] = [];
...
function convertWebTemplatesToIItems(metadataContext: IPreviewEngineContext,getPath: any): IItem[] {
  return PortalComponentServiceFactory.getPortalComponent("")?.create(metadataContext, getPath) || []; 
  // const items: IItem[] = [];
