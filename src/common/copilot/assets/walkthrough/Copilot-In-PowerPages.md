# ![Copilot Screen](./images/M365.svg) Copilot in Power Platform
...
Review the [terms](https://go.microsoft.com/fwlink/?linkid=2189520) and [Responsible AI FAQ](https://go.microsoft.com/fwlink/?linkid=2240145) documents to understand usage and limitations of Copilot. Check the following requirements to start using Copilot in Power Platform:
...
- Login to Power Platform Copilot with your Dataverse Environment credentials.
...
To know more, see [Copilot in Power Platform documentation](https://go.microsoft.com/fwlink/?linkid=2206366).
