...
function getTemplates() {
    const templates = {
        ...
        animate: "Here is the HTML div that I want to add animations to: <div class= \"row sectionBlockLayout \" style= \"display: flex; flex-wrap: wrap; min-height: auto; \" data-component-theme= \"portalThemeColor2 \"> <div class= \"container \"> <div class= \"col-md-4 columnBlockLayout \" style= \"flex-grow: 1; display: flex; flex-direction: column; margin: 30px 0px; padding: 30px; \"> <h2>Home Loans</h2> <p>Woodgrove Bank offers home loans with competitive rates and flexible repayment options. Our loan advisors can help you find the best loan for your needs.</p><button class= \"button1 \">Learn More</button> </div> <div class= \"col-md-4 columnBlockLayout \" style= \"flex-grow: 1; display: flex; flex-direction: column; margin: 30px 0px; padding: 30px; \"> <h2>Auto Loans</h2> <p>Woodgrove Bank offers auto loans with competitive rates and flexible repayment options. Our loan advisors can help you find the best loan for your needs.</p><button class= \"button1 \">Learn More</button> </div> <div class= \"col-md-4 columnBlockLayout \" style= \"flex-grow: 1; display: flex; flex-direction: column; margin: 30px 0px; padding: 30px; \"> <h2>Personal Loans</h2> <p>Woodgrove Bank offers personal loans with competitive rates and flexible repayment options. Our loan advisors can help you find the best loan for your needs.</p><button class= \"button1 \">Learn More</button> </div> </div></div>"
    };
    return templates;
}