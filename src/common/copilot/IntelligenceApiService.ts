...
export async function sendApiRequest(userPrompt: UserPrompt[], activeFileParams: IActiveFileParams, orgID: string, apiToken: string, sessionID: string, entityName: string, entityColumns: [string | null,  string | null ][], telemetry: ITelemetry, aibEndpoint: string | null) {
