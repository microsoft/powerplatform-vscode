...
import { AttributeNode, ConditionNode, EntityNode, FilterNode, LinkEntityNode, OrderNode } from "../../../models/Node";
...
export const addCondition = (node: INode) => {
    const condition = new ConditionNode(generateId());
