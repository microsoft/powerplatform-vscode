...
export const createSite = async (intelligenceEndpoint: string, intelligenceApiToken: string, userPrompt: string, siteUrl: string, sessionId: string, stream: any) => {
    ...
    const siteManager = new PowerPagesSiteManager('BlankTemplate', 'English');
