...
function createCopyItems(webpage: Webpage, getPath: any, y: string, x: string, langSuffix: string = '', content: string = ''): IItem[] {
    ...
    const copyItem = createItem(`Page Copy.html`, `Page Copy`, `Page_copy`, true, vscode.Uri.file(`${basePath}.webpage.copy.html`), "01");
    ...
    const cssItem = createItem(`${webpage.adx_name}.css`, `${webpage.adx_name}.css`, `${webpage.adx_webpageid}_css`, true, vscode.Uri.file(`${basePath}.webpage.custom_css.css`), "02");
    const jsItem = createItem(`${webpage.adx_name}.js`, `${webpage.adx_name}.js`, `${webpage.adx_webpageid}_js`, true, vscode.Uri.file(`${basePath}.webpage.custom_javascript.js`), "03");
    const summaryItem = createItem(`Page Summary.html`, `Page Summary`, `Page_summary`, true, vscode.Uri.file(`${basePath}.webpage.summary.html`), "01");
