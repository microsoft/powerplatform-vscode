    ...
    entities: {
        ...
        entity: [
            ...
            },
            {
                ...
                _propextension: "",
                _exporttype: "SubFolders",
                _fetchQueryParameters: "?$filter=_adx_webform_value eq {entityId} &$select=adx_name,adx_registerstartupscript,adx_webformstepid,adx_entityname",
                _multiFileFetchQueryParameters: "?$filter=_adx_websiteid_value eq {websiteId} &$select=adx_name,adx_registerstartupscript,adx_webformstepid,adx_entityname&$count=true",
                _attributes: "adx_registerstartupscript",
