...
export enum telemetryEventNames {
    ...
    WEB_EXTENSION_CO_PRESENCE_WORKER_ERROR = 'webExtensionCoPresenceWorkerError',
    WEB_EXTENSION_PROCESS_OPEN_ACTIVE_EDITOR_ERROR = 'webExtensionProcessOpenActiveEditorError',
}
