    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            ...
            async (args) => {
                ...
                vscode.window.showInformationMessage(localize("microsoft-powerapps-portals.webExtension.init", "testing this"));
                ...
                if (appName) {
                    switch (appName) {
                        case 'portal': {
                            ...
                            if (!accessToken) {
                                {
                                    showErrorDialog(localize("microsoft-powerapps-portals.webExtension.init", "testing this"), localize("microsoft-powerapps-portals.webExtension.init", "testing this"));
                    ...
                    vscode.window.showErrorMessage(localize("microsoft-powerapps-portals.webExtension.init", "testing this"));
