...
export const URI_HANDLER_STRINGS = {
    ...
    AGENT_HOST_CONFIRM: {
        ...
        DESCRIPTION: vscode.l10n.t("VS Code will prepare {0}, add Power Pages guidance, and start a conversation to help you create your site. No command-line experience is required."),
        ...
        SETUP_READY: vscode.l10n.t("Ready — Power Pages guidance is already available"),
        SETUP_GUIDANCE_REQUIRED: vscode.l10n.t("Power Pages guidance will be added"),
        SETUP_ASSISTANT_REQUIRED: vscode.l10n.t("AI assistant and Power Pages guidance will be prepared"),
        ...
        CHECK_GUIDANCE_TITLE: vscode.l10n.t("Check Power Pages guidance"),
        CHECK_GUIDANCE_DETAIL: vscode.l10n.t("Reuse your existing setup and add only what is missing."),
        ...
        GUIDANCE_NAME: vscode.l10n.t("Power Pages guidance"),
        ...
        STEP_CHECK_PLUGIN: vscode.l10n.t("Check whether Power Pages guidance is already available."),
