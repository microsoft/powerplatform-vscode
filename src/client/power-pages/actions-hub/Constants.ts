...
export const Constants = {
    ...
    Strings: {
        ...
        METADATA_DIFF: vscode.l10n.t("Metadata Diff"),
        METADATA_DIFF_FORMAT: vscode.l10n.t("Metadata Diff ({0} (Local <-> {1}))"),
        LOCAL: vscode.l10n.t("Local"),
        CURRENT_ENVIRONMENT: vscode.l10n.t("Current Environment"),
