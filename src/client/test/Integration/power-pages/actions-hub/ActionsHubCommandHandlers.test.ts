...
import { showEnvironmentDetails, refreshEnvironment, switchEnvironment, openActiveSitesInStudio } from '../../../../power-pages/actions-hub/ActionsHubCommandHandlers';
    ...
    describe('openActiveSitesInStudio', () => {
        ...
        describe('when service endpoint category is TEST', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.test.powerpages.microsoft.com/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is PREPROD', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.preprod.powerpages.microsoft.com/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is PROD', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.powerpages.microsoft.com/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is DOD', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.powerpages.microsoft.appsplatform.us/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is GCC', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.gov.powerpages.microsoft.us/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is HIGH', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.high.powerpages.microsoft.us/?tab=active');
            });
        });
        ...
        describe('when service endpoint category is MOONCAKE', () => {
            ...
            it('should open active sites in studio', async () => {
                ...
                expect(mockUrl.calledOnce).to.be.true;
                expect(mockUrl.firstCall.args[0]).to.equal('https://make.powerpages.microsoft.cn/?tab=active');
            });
        });
    });
});
