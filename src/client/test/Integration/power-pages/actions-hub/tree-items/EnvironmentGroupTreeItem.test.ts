...
[]);
        ...
        expect((treeItem.iconPath as { light: vscode.Uri,
dark: vscode.Uri }).light.path).to.be.equal('/src/client/assets/environment-icon/light/environment.svg');
        expect((treeItem.iconPath as { light: vscode.Uri,
dark: vscode.Uri }).dark.path).to.be.equal('/src/client/assets/environment-icon/dark/environment.svg');
    });
