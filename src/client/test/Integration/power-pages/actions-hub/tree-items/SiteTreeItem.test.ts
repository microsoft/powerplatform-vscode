...
describe('SiteTreeItem', () => {
    it('should be of type ActionsHubTreeItem', () => {
        const treeItem = new SiteTreeItem({ name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: WebsiteStatus.Active, websiteUrl: "https://foo", isCurrent: false });
    ...
    it('should have the expected contextValue when the site is Active and current', () => {
        const treeItem = new SiteTreeItem({ name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: WebsiteStatus.Active, websiteUrl: "https://foo", isCurrent: true });
    ...
    it('should have the expected contextValue when the site is Inactive', () => {
        const treeItem = new SiteTreeItem({ name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: WebsiteStatus.Inactive, websiteUrl: "https://foo", isCurrent: false });
    ...
    it('should have the expected contextValue when the site is neither Active nor Inactive', () => {
        const treeItem = new SiteTreeItem({ name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: undefined, websiteUrl: "https://foo", isCurrent: false });

        expect(treeItem.contextValue).to.be.equal("otherSite");
    });

    it('should have the expected description when site is current', () => {
        const treeItem = new SiteTreeItem({ name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: undefined, websiteUrl: "https://foo", isCurrent: true });
    ...
    it('should have the siteInfo property set to the site info passed in the constructor', () => {
        const siteInfo = { name: "Test Site", websiteId: 'test-id', dataModelVersion: 1, status: WebsiteStatus.Active, websiteUrl: "https://foo", isCurrent: false } as IWebsiteInfo;
